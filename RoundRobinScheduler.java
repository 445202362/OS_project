...
public class RoundRobinScheduler {
	...
	public RoundRobinScheduler(LinkedList<PCB> readyQueue, int totalProcesses, MemoryManager memoryManager) {
		...
		while (finishedProcesses.size() < totalProcesses) {
			...
			if (runningProcess != null) {
				...
				if (completed) {
					...
					ganttChart.add(new int[] { runningProcess.getId(), ganttStart, endTime, burstAtStart,
							runningProcess.getRemainingBurst() });
