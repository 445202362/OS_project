...
public class Main {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        do {
            // Shared queues - create new ones every run
            ...
            // Thread 1 reads job.txt and fills jobQueue
            Thread1 thread1 = new Thread1(jobQueue);

            // Thread 2 loads jobs from jobQueue to readyQueue
            Thread2 thread2 = new Thread2(jobQueue, readyQueue, thread1);
            ...
            int totalProcesses = thread1.getTotalProcesses();
            ...
            System.out.print("\nDo you want to choose another algorithm? (yes/no): ");
